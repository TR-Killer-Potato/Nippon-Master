...
interface DashboardProps {
  ...
  onSelectLesson: (lesson: ExpandedLesson, mode: "reader" | "quiz") => void;
        ...
        {filteredLessons.map((lesson) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-6 pt-4 border-t border-white/5" id={`card-actions-${lesson.id.replace(" ", "-")}`}>
                <button
                  type="button"
                  id={`btn-read-${lesson.id.replace(" ", "-")}`}
                  onClick={() => onSelectLesson(lesson, "reader")}
                  className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white text-xs font-semibold rounded-xl border border-white/10 transition-all cursor-pointer"
                >
                ...
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-amber-500 hover:bg-amber-600 text-black text-xs font-bold rounded-xl transition-all shadow-md shadow-amber-500/5 cursor-pointer hover:text-black"
                >
